...
<?php 
  ...
  $args = array(
    'posts_per_page' => 4,
    // This ensures that the posts pulled in here don't include the post whose hero is displayed at the top of the home page by index.php ($hero_post is a global variable which is set in index.php)
